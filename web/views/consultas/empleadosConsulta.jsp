...
<head>
    ...
    <title>Seleccionar Empleado por Consulta</title>
</head>
<body>
    <div class="contenedor">
        <main> 
            <div class="fondo">
                <div class="conf">
                    <h1>Selección de empleado por consulta</h1>
                    <div class="header">
                        <form action="">
    ...
    <script>
        function _Seleccionar_(row){
            ...
            var cargo = row.cells[2].innerHTML;
            window.opener.setDataEmpleadoConsulta(idempleado, empleado, cargo);
            window.close();
        }
    </script>
</body>
